...
const WinModal = ({ isOpen, score, moves, isNewBest, onPlayAgain, onShare }: WinModalProps) => {
  return (
    <Dialog open={isOpen}>
      <DialogContent className="sm:max-w-md bg-gradient-to-br from-card via-card to-primary/10 border-2 border-primary/20">
        <DialogHeader className="text-center">
          <div className="mx-auto mb-4 p-4 bg-gradient-to-br from-game-yellow to-game-orange rounded-full w-fit animate-bounce-in">
            <Trophy className="w-12 h-12 text-white" />
          </div>
          <DialogTitle className="text-3xl font-bold bg-gradient-to-r from-primary via-game-pink to-accent bg-clip-text text-transparent">
            You Won! 🎉
          </DialogTitle>
